...
def train(model, linear_classifier, optimizer, loader, epoch, n, avgpool):
    ...
    for (inp, target) in metric_logger.log_every(loader, 20, header):
        ...
        #2output
        #output = torch.cat((output, output), dim=-1)                              # 此处进行了添加
        #output1 = output + output
        
        #3output
        #output1 = torch.cat((output, output), dim=-1)                              # 此处进行了添加
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='vit_tiny4', type=str, help='Architecture')  # 此处进行了修改
    parser.add_argument('--patch_size', default=16, type=int, help='Patch resolution of the model.')
    parser.add_argument('--pretrained_weights', default='./train-T1-mask0.15/checkpoint.pth', type=str,
    ...
    parser.add_argument("--checkpoint_key", default="teacher", type=str,
                        help='Key to use in the checkpoint (example: "teacher")')  # 此处进行了修改
    ...
    parser.add_argument('--output_dir', default="./linear-T1-mask0.15", help='Path to save logs and checkpoints') 
    #parser.add_argument('--output_dir', default="./linear-T1-mask0.15-2output", help='Path to save logs and checkpoints')  # 此处进行了添加
    #parser.add_argument('--output_dir', default="./linear-T1-mask0.15-3output", help='Path to save logs and checkpoints')  # 此处进行了添加
